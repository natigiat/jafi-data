    ...
    $(".smenu-element").on("click" , function(e) {
        ...
        $.post( '/scanner/elements/element', function(data) {
            $.each(data, function(index, val) {
                ...
                $('.listElement').append('<li class="templateLi"> <div class="col-sm-4 row listProgect"> <div class="text-center col-sm-12progectName">'+val.name+'</div> <div class="col-sm-12"> <div class="templatesWebsite"></div> <div class="iframe-wrap loaded"><ifram src="/progect/element/'+val._id +"/" +val.name + '" style="margin: 0 auto; transform-origin: top left;" allowtransparency="true" width="100%" height="220px" frameborder="0" scrolling="no" align="center"></ifram></div> </div> <div class="col-sm-12 ratingTemplates"> <div class="col-sm-6"><p class="templatesPrice">Price : Free</p></div> <div class="col-sm-6 pull-right"> <a class="watch" name="watch"><i class="fa fa-eye"></i><span class="eyesValue" val="3">3</span></a> <a class="single-stat comments"><i class="fa fa-heart-o"></i>3</a> </div> </div> <div class="col-sm-12 temlatesButtons"> <a class="btn btn-primary btn-sm fixed-bottom box-shadow--2dp col-sm-6 progectLink" href="/scanner/edit/#{userId}">Edit</a> <a class="tn btn-success btn-sm fixed-bottom box-shadow--4dp col-sm-6 sec" href="/progect/element/'+val._id +"/" +val.name + '">View</a> </div> </div> </li>');
