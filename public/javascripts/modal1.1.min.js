function modalFun(e) {
    ...
    //config add editors
    var myCodeMirror = CodeMirror(document.getElementById("add-html") , {
      mode: "htmlmixed",
      theme: "ambiance",
      lineNumbers: true,
    ...
    var myCodeMirrorCss = CodeMirror(document.getElementById("add-css") , {
      mode:  "text/css",
      theme: "ambiance",
      lineNumbers: true,
      scrollbarStyle: "simple",
    ...
    var myCodeMirrorJs = CodeMirror(document.getElementById("add-js") , {
